...
void InitDataBuf()
{
	...
	{
		dsmRangePtr->dmRange[i].lengthInLogicalBlocks = 0;
		dsmRangePtr->dmRange[i].startingLBA[0] = 0;
		dsmRangePtr->dmRange[i].startingLBA[1] = 0;
		dsmRangePtr->dmRange[i].ContextAttributes.value = 0;
	}
	dsmRangePtr->head=0;
	dsmRangePtr->tail=0;
