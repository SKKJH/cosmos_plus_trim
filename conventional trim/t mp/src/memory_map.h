...
#define TEMPORARY_REG_BUFFER_MAP_ADDR 		(TEMPORARY_DATA_BUFFER_MAP_ADDR + sizeof(TEMPORARY_DATA_BUF_MAP))
// for map tables
#define LOGICAL_SLICE_MAP_ADDR				(TEMPORARY_REG_BUFFER_MAP_ADDR + sizeof(REG_BUF_MAP))
