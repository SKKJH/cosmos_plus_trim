...
//		if(req_cnt > 100)
//		{
//			unsigned int utilization = 100 * (((real_write_cnt) * 16) / 1024) / (storageCapacity_L / ((1024 * 1024) / BYTES_PER_NVME_BLOCK));
//			unsigned int victimBlockNo = GetFromGcVictimListNum(g_die);
//			if (victimBlockNo != 0xffff)
//			{
//				unsigned int valid_page = (128 - virtualBlockMapPtr->block[g_die][victimBlockNo].invalidSliceCnt);
//				xil_printf("utilization: %d Percent\n", utilization);
//				xil_printf("valid_page: %u\r\n", valid_page);
//				xil_printf("==================\r\n");
//			}
//			req_cnt = 0;
//		}
...
//		virtualSliceAddr = FindFreeVirtualSlice_SBGC();
