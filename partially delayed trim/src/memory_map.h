...
// for async trim bitmap
#define ASYNC_TRIM_BIT_MAP_ADDR 			(WAY_PRIORITY_TABLE_ADDR + sizeof(WAY_PRIORITY_TABLE))
#define DSM_RANGE_HASH_TABLE_ADDR			(ASYNC_TRIM_BIT_MAP_ADDR + sizeof(ASYNC_TRIM_BIT_MAP))
#define DSM_RANGE_ADDR 						(DSM_RANGE_HASH_TABLE_ADDR + sizeof(DSM_RANGE_HASH_TABLE))
#define TEMPORARY_REG_BUFFER_MAP_ADDR 		(DSM_RANGE_ADDR + sizeof(DSM_RANGE))

#define FTL_MANAGEMENT_END_ADDR				((TEMPORARY_REG_BUFFER_MAP_ADDR + sizeof(REG_BUF_MAP))- 1)
